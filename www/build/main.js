...
var DataServiceProvider = /** @class */ (function () {
    ...
    DataServiceProvider.prototype.payBill = function (item, index) {
        console.log(index);
