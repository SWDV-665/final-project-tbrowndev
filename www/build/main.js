...
var BudgetPage = /** @class */ (function () {
    ...
    BudgetPage.prototype.removeManualItem = function (record) {
        this.presentDeletePrompt(record);
    };
    BudgetPage.prototype.presentDeletePrompt = function (record) {
        var _this = this;
        var prompt = this.alertCtrl.create({
            ...
            buttons: [
                ...
                },
                {
                    text: 'Yes',
                    handler: function (data) {
                        _this.dataService.deleteRecord(record);
                    }
                }
            ]
        });
        ...
        var prompt = this.alertCtrl.create({
            ...
            buttons: [
                ...
                },
                {
                    text: 'Yes',
                    handler: function (data) {
                        _this.dataService.deleteRecord(_this.record);
                        _this.close();
                    }
                }
            ]
